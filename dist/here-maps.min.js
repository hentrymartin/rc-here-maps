...
var HereMaps = function (_PureComponent) {
  ...
  function HereMaps(props) {
    ...
    _this.onMapLoaded = function (map, behavior) {
      _this.setState({
        map: map,
        behavior: behavior
      });
    ...
    value: function render() {
      ...
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        ...
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.Children.map(children, function (child) {
          ...
          return __WEBPACK_IMPORTED_MODULE_0_react___default.a.cloneElement(child, { map: map, behavior: behavior });
        })
      );
    }
  }]);
  ...
  function Map(props) {
    ...
    _this.setMap = function (map, mapTypes) {
      _this.setState({
        ...
        _this.props.onMapLoaded(map, behaviour);
      });
    };

...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../node_modules/css-loader/index.js??ref--1-oneOf-2-1!../node_modules/sass-loader/lib/loader.js!../node_modules/postcss-loader/lib/index.js??postcss!./HereMaps.scss", function() {
			var newContent = require("!!../node_modules/css-loader/index.js??ref--1-oneOf-2-1!../node_modules/sass-loader/lib/loader.js!../node_modules/postcss-loader/lib/index.js??postcss!./HereMaps.scss");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__HereMap__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Marker__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Polygon__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Polyline__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Circle__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Rectangle__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__PathFinder__ = __webpack_require__(35);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "HereMap", function() { return __WEBPACK_IMPORTED_MODULE_0__HereMap__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "Marker", function() { return __WEBPACK_IMPORTED_MODULE_1__Marker__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "Polygon", function() { return __WEBPACK_IMPORTED_MODULE_2__Polygon__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "Polyline", function() { return __WEBPACK_IMPORTED_MODULE_3__Polyline__["a"]; });
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "Rectangle", function() { return __WEBPACK_IMPORTED_MODULE_5__Rectangle__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "PathFinder", function() { return __WEBPACK_IMPORTED_MODULE_6__PathFinder__["a"]; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Map__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__HereMaps_scss__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__HereMaps_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__HereMaps_scss__);
...
var HereMaps = function (_PureComponent) {
  _inherits(HereMaps, _PureComponent);

  function HereMaps(props) {
    _classCallCheck(this, HereMaps);

    var _this = _possibleConstructorReturn(this, (HereMaps.__proto__ || Object.getPrototypeOf(HereMaps)).call(this, props));

    _this.onMapLoaded = function (map, behavior, factory) {
      _this.setState({
        map: map,
        behavior: behavior,
        factory: factory
  ...
  _createClass(HereMaps, [{
    ...
    value: function render() {
      ...
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        ...
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__Map__["a" /* default */], Object.assign({}, this.props, { onMapLoaded: this.onMapLoaded })),
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.Children.map(children, function (child) {
          if (!child) return null;
          return __WEBPACK_IMPORTED_MODULE_0_react___default.a.cloneElement(child, { map: map, behavior: behavior, factory: factory });
        })
      );
    }
  }]);
...
HereMaps.propTypes = {
   ...
   * Heremaps App ID
   */
  appId: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.string,
  /**
   * Heremaps App Code
   */
  appCode: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.string,
  /**
   * If true then works in https
   */
  useHTTPS: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.bool,
  /**
   * Called when the map is loaded. This returns the map object.
   */
  onMapLoaded: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.func,
  /**
   ...
   */
  bounds: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.object,
  /**
...
/* harmony default export */ __webpack_exports__["a"] = (HereMaps);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Factories_HereMapFactory__ = __webpack_require__(22);
...
var Map = function (_Component) {
  ...
  function Map(props) {
    ...
    _this.setMap = function (map, mapTypes) {
      _this.setState({
        map: map
      }, function () {
        // Enabling zoom and drag events
        var behaviour = new window.H.mapevents.Behavior(new window.H.mapevents.MapEvents(map));

        // This creates the UI controls
        window.H.ui.UI.createDefault(map, mapTypes);

        // Send to parent the created map object
        _this.props.onMapLoaded(map, behaviour, _this.factory);
      });
    };

    _this.updateCenter = function (center) {
      if (Object(__WEBPACK_IMPORTED_MODULE_4__Utils__["a" /* isEmpty */])(center)) return;
      _this.state.map.setCenter(center);
    };

    _this.updateBounds = function (bounds) {
      if (Object(__WEBPACK_IMPORTED_MODULE_4__Utils__["a" /* isEmpty */])(bounds)) return;
      var rect = new window.H.geo.Rect(bounds.north, bounds.south, bounds.east, bounds.west);
      _this.state.map.setViewBounds(rect);
    };

    _this.factory = Object(__WEBPACK_IMPORTED_MODULE_3__Factories_HereMapFactory__["a" /* default */])(props.appId, props.appCode, props.useHTTPS);

    // Produces the platform object
    _this.platform = _this.factory.getPlatform();
  ...
  _createClass(Map, [{
    ...
    value: function shouldComponentUpdate(nextProps) {
      if (this.state.map) {
        ...
        if (!Object(__WEBPACK_IMPORTED_MODULE_4__Utils__["b" /* isEqual */])(this.props.center, nextProps.center)) this.updateCenter(nextProps.center);

        // If the bounds are changed then update the bounds
        if (!Object(__WEBPACK_IMPORTED_MODULE_4__Utils__["b" /* isEqual */])(this.props.bounds, nextProps.bounds)) this.updateBounds(nextProps.bounds);
      }
    ...
    value: function componentDidMount() {
      ...
      var map = this.factory.getHereMap(element, mapTypes.normal.map, {
        zoom: zoom,
        center: center,
    ...
    */
    ...
    key: 'render',
    value: function render() {
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div', { className: 'here-map-container' });
    }
  }]);
...
Map.propTypes = {
  onMapLoaded: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.func,
  appId: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.string,
  appCode: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.string,
  useHTTPS: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.bool,
  center: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.object,
  bounds: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.object,
  zoom: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.number
};
...
var aa = __webpack_require__(0),
    ...
    ba = __webpack_require__(7);function ca(a, b, c, d, e, f, g, h) {
  if (!a) {
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var _typeof=typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?function(obj){return typeof obj;}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;};if(process.env.NODE_ENV!=="production"){(function(){'use strict';var React=__webpack_require__(0);var _assign=__webpack_require__(4);var checkPropTypes=__webpack_require__(6);var schedule=__webpack_require__(7);var tracing=__webpack_require__(19);/**
...
"use strict";
/* harmony default export */ __webpack_exports__["a"] = (function (appId, appCode) {
  ...
  return {
    ...
    getHereMap: function getHereMap(container, mapType, options) {
...
// module
exports.push([module.i, ".here-map-container {\n  height: 100%;\n  width: 100%; }\n", ""]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__HereMaps_scss__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__HereMaps_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__HereMaps_scss__);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var Marker = function (_Component) {
  ...
  function Marker(props) {
    ...
    _this.getDomMarkerIcon = function (html) {
      return new window.H.map.DomIcon(html);
    };

    _this.createMarker = function () {
      if (_this.marker) map.removeObject(_this.marker);
      ...
      var htmlEl = __WEBPACK_IMPORTED_MODULE_1_react_dom_server___default.a.renderToStaticMarkup(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div', { className: 'rc-marker' }, children));
      var icon = _this.getDomMarkerIcon(htmlEl);
      var marker = new window.H.map.DomMarker({ lat: lat, lng: lng }, { icon: icon });
      marker.addEventListener('tap', _this.props.onClick);
      if (draggable) {
        marker.draggable = true;
        _this.addEventListeners();
      }
      map.addObject(marker);
      _this.props.onMarkerCreated(marker);
      _this.marker = marker;
    };

    _this.updateMarker = function () {
      var children = _this.props.children;

      var htmlEl = __WEBPACK_IMPORTED_MODULE_1_react_dom_server___default.a.renderToStaticMarkup(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        'div',
        { className: 'rc-marker' },
        children
      ));
    ...
    _this.addEventListeners = function () {
      ...
      map.addEventListener('dragstart', _this.onDragStart, false);

      // re-enable the default draggability of the underlying map
      // when dragging has completed
      map.addEventListener('dragend', _this.onDragEnd, false);

      // Listen to the drag event and move the position of the marker
      // as necessary
      map.addEventListener('drag', _this.onDrag, false);
    };

    _this.removeEventListeners = function () {
      var map = _this.props.map;

      map.removeEventListener('dragstart', _this.onDragStart, false);
      map.removeEventListener('dragend', _this.onDragStart, false);
      map.removeEventListener('drag', _this.onDragStart, false);
    };
    ...
    _this.onDrag = function (e) {
      var target = e.target,
          currentPointer = e.currentPointer;
      var map = _this.props.map;
  ...
  _createClass(Marker, [{
    ...
    value: function componentWillUnmount() {
      ...
      if (Object(__WEBPACK_IMPORTED_MODULE_3__Utils__["a" /* isEmpty */])(map)) return;
    ...
    value: function render() {
      ...
      if (!Object(__WEBPACK_IMPORTED_MODULE_3__Utils__["a" /* isEmpty */])(map) && !this.marker) {
        this.createMarker();
      } else if (this.marker) {
        this.updateMarker();
      }
...
Marker.defaultProps = {
  lat: 0,
  lng: 0,
  onMarkerCreated: function onMarkerCreated() {},
...
Marker.propTypes = {
   ...
   */
  lat: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.number.isRequired,
  /**
   * Longitude position of the marker
   */
  lng: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.number.isRequired,
  /**
   ...
   */
  draggable: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.bool,
  /**
   * Click handler for marker
   */
  onClick: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.func,
  behavior: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.object
};
...
var p = __webpack_require__(4),
    q = __webpack_require__(0);function aa(a, b, d, c, k, f, h, l) {
  if (!a) {
    a = void 0;if (void 0 === b) a = Error("Minified exception occurred; use the non-minified dev environment for the full error message and additional helpful warnings.");else {
      var D = [d, c, k, f, h, l],
...
function I(a) {
  if (null == a) return null;if ("function" === typeof a) return a.displayName || a.name || null;if ("string" === typeof a) return a;switch (a) {case G:
    ...
    L = {};
function M(a) {
  if (J.call(L, a)) return !0;if (J.call(K, a)) return !1;if (ca.test(a)) return L[a] = !0;K[a] = !0;return !1;
}function da(a, b, d, c) {
...
function ea(a, b, d, c) {
  if (null === b || "undefined" === typeof b || da(a, b, d, c)) return !0;if (c) return !1;if (null !== d) switch (d.type) {case 3:
      return !b;case 4:
      return !1 === b;case 5:
      return isNaN(b);case 6:
      return isNaN(b) || 1 > b;}return !1;
}function N(a, b, d, c, k) {
  this.acceptsBooleans = 2 === b || 3 === b || 4 === b;this.attributeName = c;this.attributeNamespace = k;this.mustUseProperty = d;this.propertyName = a;this.type = b;
}var O = {};
"children dangerouslySetInnerHTML defaultValue defaultChecked innerHTML suppressContentEditableWarning suppressHydrationWarning style".split(" ").forEach(function (a) {
...
});O.tabIndex = new N("tabIndex", 1, !1, "tabindex", null);var fa = /["'&<>]/;
function R(a) {
  if ("boolean" === typeof a || "number" === typeof a) return "" + a;a = "" + a;var b = fa.exec(a);if (b) {
    var d = "",
        c,
      ...
      switch (a.charCodeAt(c)) {case 34:
          ...
          b = "&lt;";break;case 62:
          b = "&gt;";break;default:
          continue;}k !== c && (d += a.substring(k, c));k = c + 1;d += b;
...
var U = { area: !0, base: !0, br: !0, col: !0, embed: !0, hr: !0, img: !0, input: !0, keygen: !0, link: !0, meta: !0, param: !0, source: !0, track: !0, wbr: !0 },
  ...
  gridColumnStart: !0, fontWeight: !0, lineClamp: !0, lineHeight: !0, opacity: !0, order: !0, orphans: !0, tabSize: !0, widows: !0, zIndex: !0, zoom: !0, fillOpacity: !0, floodOpacity: !0, stopOpacity: !0, strokeDasharray: !0, strokeDashoffset: !0, strokeMiterlimit: !0, strokeOpacity: !0, strokeWidth: !0 },
    ia = ["Webkit", "ms", "Moz", "O"];Object.keys(V).forEach(function (a) {
...
function sa(a, b) {
  function d(c, k) {
    var d = oa(k, b),
        ...
        e = void 0;if (k.prototype && k.prototype.isReactComponent) {
      if (e = new k(c.props, d, g), "function" === typeof k.getDerivedStateFromProps) {
        var v = k.getDerivedStateFromProps.call(null, c.props, e.state);null != v && (e.state = p({}, e.state, v));
      }
      ...
      g = f;var t = h;f = null;h = !1;if (t && 1 === g.length) e.state = g[0];else {
    ...
    } else f = null;a = e.render();ra(a, k);c = void 0;if ("function" === typeof e.getChildContext && (d = k.childContextTypes, "object" === (typeof d === "undefined" ? "undefined" : _typeof(d)))) {
    ...
    var c = a,
        k = c.type;if ("function" !== typeof k) break;d(c, k);
  }return { child: a,
    context: b };
}
var ta = function () {
  function a(b, d) {
    ...
    var b = ++this.contextIndex,
        c = a.type._context,
        k = c._currentValue;this.contextStack[b] = c;this.contextValueStack[b] = k;c._currentValue = a.props.value;
    ...
    if (this.exhausted) return null;for (var b = ""; b.length < a;) {
      if (0 === this.stack.length) {
        ...
        var k = c.footer;b += k;"" !== k && (this.previousWasTextNode = !1);this.stack.pop();"select" === c.type ? this.currentSelectValue = null : null != c.type && null != c.type.type && c.type.type.$$typeof === E && this.popProvider(c.type);
    ...
    }d = sa(a, d);a = d.child;d = d.context;if (null === a || !1 === a) return "";if (!q.isValidElement(a)) {
      if (null != a && null != a.$$typeof) {
        var b = a.$$typeof;b === y ? r("257") : void 0;r("258", b.toString());
        ...
        return b = W(a.props.children(a.type._currentValue)), this.stack.push({ type: a, domNamespace: c, children: b, childIndex: 0, context: d,
          footer: "" }), "";}r("130", null == b ? b : typeof b === "undefined" ? "undefined" : _typeof(b), "");
  };a.prototype.renderDOM = function (a, d, c) {
    var b = a.type.toLowerCase();c === S.html && T(b);X.hasOwnProperty(b) || (ma.test(b) ? void 0 : r("65", b), X[b] = !0);var f = a.props;if ("input" === b) f = p({ type: void 0 }, f, { defaultChecked: void 0, defaultValue: void 0, value: null != f.value ? f.value : f.defaultValue, checked: null != f.checked ? f.checked : f.defaultChecked });else if ("textarea" === b) {
      var h = f.value;if (null == h) {
        h = f.defaultValue;var l = f.children;null != l && (null != h ? r("92") : void 0, Array.isArray(l) && (1 >= l.length ? void 0 : r("93"), l = l[0]), h = "" + l);null == h && (h = "");
      ...
      l = this.currentSelectValue;var D = na(f.children);if (null != l) {
        var z = null != f.value ? f.value + "" : D;h = !1;if (Array.isArray(l)) for (var g = 0; g < l.length; g++) {
          if ("" + l[g] === z) {
            h = !0;break;
          }
        } else h = "" + l === z;f = p({ selected: void 0, children: void 0 }, f, { selected: h, children: D });
      }
    }if (h = f) ha[b] && (null != h.children || null != h.dangerouslySetInnerHTML ? r("137", b, "") : void 0), null != h.dangerouslySetInnerHTML && (null != h.children ? r("60") : void 0, "object" === _typeof(h.dangerouslySetInnerHTML) && "__html" in h.dangerouslySetInnerHTML ? void 0 : r("61")), null != h.style && "object" !== _typeof(h.style) ? r("62", "") : void 0;h = f;l = this.makeStaticMarkup;D = 1 === this.stack.length;z = "<" + a.type;for (u in h) {
      if (pa.call(h, u)) {
        var e = h[u];if (null != e) {
          if ("style" === u) {
            g = void 0;var v = "",
              ...
              if (e.hasOwnProperty(g)) {
                var m = 0 === g.indexOf("--"),
                    n = e[g];if (null != n) {
                  var w = g;if (Y.hasOwnProperty(w)) w = Y[w];else {
                    var xa = w.replace(ja, "-$1").toLowerCase().replace(ka, "-ms-");w = Y[w] = xa;
                  }v += t + w + ":";t = g;m = null == n || "boolean" === typeof n || "" === n ? "" : m || "number" !== typeof n || 0 === n || V.hasOwnProperty(t) && V[t] ? ("" + n).trim() : n + "px";v += m;t = ";";
                }
              }
            }e = v || null;
          }g = null;b: if (m = b, n = h, -1 === m.indexOf("-")) m = "string" === typeof n.is;else switch (m) {case "annotation-xml":case "color-profile":case "font-face":case "font-face-src":case "font-face-uri":case "font-face-format":case "font-face-name":case "missing-glyph":
              m = !1;break b;default:
              m = !0;}if (m) qa.hasOwnProperty(u) || (g = u, g = M(g) && null != e ? g + "=" + ('"' + R(e) + '"') : "");else {
            m = u;g = e;e = O.hasOwnProperty(m) ? O[m] : null;if (n = "style" !== m) n = null !== e ? 0 === e.type : !(2 < m.length) || "o" !== m[0] && "O" !== m[0] || "n" !== m[1] && "N" !== m[1] ? !1 : !0;n || ea(m, g, e, !1) ? g = "" : null !== e ? (m = e.attributeName, e = e.type, g = 3 === e || 4 === e && !0 === g ? m + '=""' : m + "=" + ('"' + R(g) + '"')) : g = M(m) ? m + "=" + ('"' + R(g) + '"') : "";
          }g && (z += " " + g);
        }
      }
    }l || D && (z += ' data-reactroot=""');var u = z;h = "";U.hasOwnProperty(b) ? u += "/>" : (u += ">", h = "</" + a.type + ">");a: {
    ...
    }null != l ? (f = [], la[b] && "\n" === l.charAt(0) && (u += "\n"), u += l) : f = W(f.children);a = a.type;c = null == c || "http://www.w3.org/1999/xhtml" === c ? T(a) : "http://www.w3.org/2000/svg" === c && "foreignObject" === a ? "http://www.w3.org/1999/xhtml" : c;this.stack.push({ domNamespace: c, type: b, children: f, childIndex: 0, context: d, footer: h });this.previousWasTextNode = !1;return u;
  };return a;
}(),
    ua = { renderToString: function renderToString(a) {
    ...
    va = { default: ua },
    wa = va && ua || va;module.exports = wa.default || wa;
...
var Polygon = function (_Component) {
  ...
  function Polygon(props) {
    ...
    _this.createPolygon = function () {
      ...
      var geometry = _this.getGeometry(dataPoints);
      _this.polygon = new window.H.map.Polygon(geometry, {
        style: {
          fillColor: fillColor,
      ...
      _this.polygon.addEventListener('tap', _this.props.onClick);
      _this.props.onPolygonDrawn(_this.polygon);
      map.addObject(_this.polygon);
    };

    _this.updatePolygon = function () {
      var dataPoints = _this.props.dataPoints;


      var geometry = _this.getGeometry(dataPoints);
      _this.polygon.setGeometry(geometry);
    };
  ...
  _createClass(Polygon, [{
    ...
    value: function componentDidUpdate(prevProps) {
      if (this.polygon) {
        ...
        if (!Object(__WEBPACK_IMPORTED_MODULE_2__Utils__["b" /* isEqual */])(prevProps.dataPoints, this.props.dataPoints)) this.updatePolygon();
      }
    }
  }, {
    key: 'componentWillUnmount',
    value: function componentWillUnmount() {
      ...
      if (Object(__WEBPACK_IMPORTED_MODULE_2__Utils__["a" /* isEmpty */])(map)) return;
    ...
    value: function render() {
      ...
      if (!Object(__WEBPACK_IMPORTED_MODULE_2__Utils__["a" /* isEmpty */])(map) && !this.polygon) {
        this.createPolygon();
      }
...
Polygon.defaultProps = {
  ...
  strokeColor: '#829',
  lineWidth: 1,
  onPolygonDrawn: function onPolygonDrawn() {},
  onClick: function onClick() {}
};
...
Polygon.propTypes = {
   ...
   */
  dataPoints: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.array,
  /**
   * The filling color in CSS syntax, the default is #FFFFCC. It can be hex or rgba value.
   */
  fillColor: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.string,
  /**
   * The color of the stroke in CSS syntax, the default is #829.
   */
  strokeColor: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.string,
  /**
   * width of the line in pixels. Defaults to 1.
   */
  lineWidth: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.number,
  /**
   * Called when the polygon is added to the map
   */
  onPolygonDrawn: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.func,
  /**
...
var Polyline = function (_Component) {
  ...
  function Polyline(props) {
    ...
    _this.updatePolyline = function () {
      var dataPoints = _this.props.dataPoints;


      var geometry = _this.getGeometry(dataPoints);
      _this.polyline.setGeometry(geometry);
    };

    _this.getGeometry = function () {
      return new window.H.geo.LineString(_this.props.dataPoints, 'lat lng alt');
    };

    _this.createPolyline = function () {
      ...
      var _this$props = _this.props,
          ...
          strokeColor = _this$props.strokeColor,
          lineWidth = _this$props.lineWidth,
          miterLength = _this$props.miterLength,
          lineDash = _this$props.lineDash,
          lineDashOffset = _this$props.lineDashOffset;

      _this.polyline = new window.H.map.Polyline(geometry, {
        style: {
          strokeColor: strokeColor,
          lineWidth: lineWidth,
      ...
      _this.props.onPolylineDrawn(_this.polyline);
      map.addObject(_this.polyline);
    };
  ...
  _createClass(Polyline, [{
    ...
    value: function componentDidUpdate(prevProps) {
      if (this.polyline) {
        ...
        if (!Object(__WEBPACK_IMPORTED_MODULE_2__Utils__["b" /* isEqual */])(prevProps.dataPoints, this.props.dataPoints)) this.updatePolyline();
      }
    }
  }, {
    key: 'componentWillUnmount',
    ...
    */
    ...
    value: function render() {
      ...
      if (!Object(__WEBPACK_IMPORTED_MODULE_2__Utils__["a" /* isEmpty */])(map) && !this.polyline) this.createPolyline();
      return null;
    }
  }]);
...
Polyline.defaultProps = {
  ...
  lineDash: [],
  lineDashOffset: 0,
  onPolylineDrawn: function onPolylineDrawn() {}
};
...
Polyline.propTypes = {
   ...
   */
  miterLength: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.number,
  /**
   * Called when the polyline is added to the map
   */
  onPolylineDrawn: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.func
};
...
var Circle = function (_Component) {
  ...
  function Circle(props) {
    ...
    _this.createCircle = function () {
      ...
      _this.circle = new window.H.map.Circle(center, radius, {
        style: {
          fillColor: fillColor,
          strokeColor: strokeColor,
          lineWidth: lineWidth
      ...
      _this.circle.addEventListener('tap', _this.props.onClick);
      _this.props.onCircleDrawn(_this.circle);
      map.addObject(_this.circle);
    };

    _this.updateCircle = function () {
  ...
  _createClass(Circle, [{
    ...
    value: function componentDidUpdate(prevProps) {
      if (this.circle) {
        ...
        if (!Object(__WEBPACK_IMPORTED_MODULE_2__Utils__["b" /* isEqual */])(prevProps.center, this.props.center) || prevProps.radius !== this.props.radius) this.updateCircle();
      }
    }
  }, {
    key: 'componentWillUnmount',
    ...
    */
    ...
    value: function render() {
      ...
      if (!Object(__WEBPACK_IMPORTED_MODULE_2__Utils__["a" /* isEmpty */])(map) && !this.circle) {
        this.createCircle();
      }
...
Circle.defaultProps = {
  ...
  strokeColor: '#829',
  lineWidth: 2,
  onCircleDrawn: function onCircleDrawn() {},
  onClick: function onClick() {}
};
...
Circle.propTypes = {
   ...
   */
  center: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.object.isRequired,
  /**
   ...
   */
  onCircleDrawn: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.func,
  /**
...
var Rectangle = function (_Component) {
  ...
  function Rectangle(props) {
    ...
    _this.getGeometry = function (bounds) {
    ...
    _this.createRectangle = function () {
      ...
      _this.rectangle = new window.H.map.Rect(_this.getGeometry(bounds), {
        style: {
          fillColor: fillColor,
          strokeColor: strokeColor,
          lineWidth: lineWidth
      ...
      _this.rectangle.addEventListener('tap', _this.props.onClick);
      _this.props.onRectangleDrawn(_this.rectangle);
      map.addObject(_this.rectangle);
    };

    _this.updateRectangle = function () {
      var bounds = _this.props.bounds;

      _this.rectangle.setBounds(_this.getGeometry(bounds));
    };
  ...
  _createClass(Rectangle, [{
    ...
    value: function componentDidUpdate(prevProps) {
      if (this.rectangle) {
        ...
        if (!Object(__WEBPACK_IMPORTED_MODULE_2__Utils__["b" /* isEqual */])(prevProps.bounds, this.props.bounds)) this.updateRectangle();
      }
    }
  }, {
    key: 'componentWillUnmount',
    ...
    value: function render() {
      ...
      if (!Object(__WEBPACK_IMPORTED_MODULE_2__Utils__["a" /* isEmpty */])(map) && !this.rectangle) {
...
Rectangle.defaultProps = {
  ...
  strokeColor: '#829',
  lineWidth: 1,
  onRectangleDrawn: function onRectangleDrawn() {},
  onClick: function onClick() {}
};
...
Rectangle.propTypes = {
   ...
   * }
   */
  bounds: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.object.isRequired,
  /**
   ...
   */
  onRectangleDrawn: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.func,
  /**
   * Click handler for Reactange
   */
  onClick: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.func
...
var PathFinder = function (_Component) {
  ...
  function PathFinder(props) {
    ...
    var _this = _possibleConstructorReturn(this, (PathFinder.__proto__ || Object.getPrototypeOf(PathFinder)).call(this, props));

    _this.createRouter = function (factory) {
      var platform = factory.getPlatform();
  ...
  _createClass(PathFinder, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      var factory = nextProps.factory;
      // Once factory is available then create platform and create router

      if (!Object(__WEBPACK_IMPORTED_MODULE_2__Utils__["b" /* isEqual */])(factory, this.props.factory)) {
...
PathFinder.propTypes = {
  mode: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.PropTypes.arrayOf(__WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.oneOf(['faster', 'car'])),
  representation: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.arrayOf(__WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.oneOf(['display'])),
  routerattributes: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.arrayOf(__WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.oneOf(['waypoints', 'summary', 'shape', 'legs'])),
  maneuverattributes: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.arrayOf(__WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.oneOf(['direction', 'action'])),
  waypoints: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.array,
  departure: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.instanceOf(Date),
  arrival: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.instanceOf(Date),
  alternatives: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.number,
  viewBounds: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.shape({
    north: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.number,
    south: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.number,
    east: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.number,
    west: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.number
  })
};

/* harmony default export */ __webpack_exports__["a"] = (PathFinder);

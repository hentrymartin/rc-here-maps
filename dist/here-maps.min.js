...
var Marker = function (_Component) {
  ...
  function Marker(props) {
    ...
    _this.createMarker = function () {
      ...
      marker.addEventListener('pointerenter', _this.props.onMouseEnter);
      marker.addEventListener('pointerleave', _this.props.onMouseLeave);
      if (draggable) {
...
var PathFinder = function (_Component) {
  ...
  _createClass(PathFinder, [{
     ...
     */
    value: function createPath(route) {
      ...
      var path = new window.H.map.Polyline(strip, { style: style });
    ...
    key: 'waypointsToRouteParams',
    value: function waypointsToRouteParams(waypoints) {
      var params = {};
    ...
    value: function render() {
      ...
      var routeRequestWaypoints = this.waypointsToRouteParams(this.props.waypoints);
      var routeRequestParams = Object.assign({
      ...
      if (this.router) {
        this.router.calculateRoute(routeRequestParams, function (result) {
          if (result.response && result.response.route[0]) {
            _this2.createPath(result.response.route[0]);
          }
        }, function (error) {
...
PathFinder.defaultProps = {
  ...
  alternatives: 1,
  onPathCreated: function onPathCreated() {},
  style: {
    lineWidth: 4,
...
PathFinder.propTypes = {
  ...
  representation: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.string,
  routeattributes: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.string,
  maneuverattributes: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.string,
  waypoints: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.arrayOf(__WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.shape({
  ...
  avoidLinks: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.string,
  avoidSeasonalClosures: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.bool,
  alternatives: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.number,
  onPathCreated: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.func,
